...
if ( ! function_exists( 'understrap_posted_on_single' ) ) {
	/**
	 * Prints HTML with meta information for the current post-date/time and author.
	 */
	function understrap_posted_on_single() {
		$time_string = '<h4>Post Date</h4><time class="entry-date published updated" datetime="%1$s">%2$s</time>';
