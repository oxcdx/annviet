...
<div class="position-relative" id="page-wrapper">
	...
	<div class="<?php echo esc_attr( $container ); ?> p-0" id="content">
		...
		<div class="">
          ...
          if( $image_1['image'] ) $slideCount++;
          if( $image_2['image'] ) $slideCount++; 
          if( $image_3['image'] ) $slideCount++; 
          if( $image_4['image'] ) $slideCount++; 
          if( $image_5['image'] ) $slideCount++; 

          if( $image_1['image'] || $image_2['image'] || $image_3['image'] || $image_4['image'] || $image_5['image'] ): ?>
              <div id="carouselExampleCaptions" class="carousel ox-carousel carousel-dark slide" data-bs-ride="carousel" data-bs-interval="false">
                <?php if($slideCount > 1): ?>
